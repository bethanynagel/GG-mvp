...
Gem::Specification.new do |s|
  ...
  s.files = ["BSD", "Contributors.rdoc", "GPL", "History.rdoc", "LICENSE", "Manifest.txt", "README.OS_X.rdoc", "README.ja.rdoc", "README.rdoc", "README.windows.rdoc", "ext/compat.c", "ext/extconf.rb", "ext/pg.c"]
